...
- Challenges we ran into
  - Our code kept crashing various times when trying to run the application. This happened especially when we were trying to format our application with text and user input, such as with sliders and dropdown boxes. 
  
- Accomplishments that we’re proud of
  - We are proud that our application was able to run smoothly after a series of trials and errors. It was able to provide a valid output to the user based on their input. 
